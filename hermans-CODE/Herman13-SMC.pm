...
x12  : [0..1];
x13  : [0..1];
[]  (x1=x13) & (m=0) -> p1 : (x1'=0) & (m'=1)+ 1-p1 : (x1'=1)& (m'=1);
[] !(x1=x13) & (m=0)-> (x1'=1)& (m'=1);
endmodule
...
x12  : [0..1];
x13  : [0..1];
[]  (x13=x12) & (m=12) -> p13 : (x13'=0) & (m'=0)+ 1-p13 : (x13'=1)& (m'=0);
[] !(x13=x12) & (m=12)-> (x13'=1)& (m'=0);

endmodule
rewards

[]x1+x2+x3+x4+x5+x6+x7+x8+x9+x10+x11+x12+x13=10 : 1;

endrewards

init
x1 = 1 & x2 = 1 & x3 = 1 & x4 = 1 & x5 = 1 & x6 = 1 & x7 = 1 & x8 = 1 & x9 = 1 & x10 = 1 & x11 = 1& x12 = 1 & x13 = 1
endinit
