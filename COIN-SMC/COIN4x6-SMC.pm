...
sf4 : [0..2];
x6 : [0..4] ;
[] sf1=0 & (x6=0) -> p1 : (sf1'=1) & (x6'=1) + 1-p1 : (sf1'=2) & (x6'=1) ;
[] sf2=0 & (x6=1) -> p2 : (sf2'=1) & (x6'=2) + 1-p2 : (sf2'=2) & (x6'=2);
[] sf3=0 & (x6=2) -> p3 : (sf3'=1) & (x6'=3) + 1-p3 : (sf3'=2) & (x6'=3);
[] sf4=0 & (x6=3) -> p4 : (sf4'=1) & (x6'=4) + 1-p4 : (sf4'=2) & (x6'=4) ;
endmodule
...
[]sum=16 & x1=4 & x2=4 & x3=4 & x4=4 & x5=4 & x6=4: 1;
