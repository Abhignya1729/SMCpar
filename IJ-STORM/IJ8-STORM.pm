...
[] (p=0) -> 1/8 : (p'=1) + 1/8 : (p'=2) + 1/8 : (p'=3) + 1/8 : (p'=4) + 1/8 : (p'=5) + 1/8 : (p'=6) + 1/8 : (p'=7) + 1/8 : (p'=8) ;
...
[] (q1=1) & (p=1) -> x1 : (q1'=0) & (q8'=1) & (p'=0) + 1-x1 : (q1'=0) & (q2'=1) & (p'=0);
...
[] (q7=1) & (p=7) -> x7 : (q7'=0) & (q6'=1) & (p'=0) + 1-x7 : (q7'=0) & (q8'=1) & (p'=0);

endmodule

module process8

[] (q8=1) & (p=8) -> x8 : (q8'=0) & (q7'=1) & (p'=0) + 1-x8 : (q8'=0) & (q1'=1) & (p'=0);
