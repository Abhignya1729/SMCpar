...
class Module:
    ...
    def get_possible_transitions(self, global_substitution):
        ...
        # print("globalsubs", global_substitution, "selfcurrent" , self.current_value_state)
    ...
    def copy(self, name):
        ...
        mod.trans = []
        #for namet, cond, outcom, funcond in self.trans:
    ...
    def maj(self, update, global_valu):
        ...
        # print("update", update, "globalvalue", global_valu)
