    ...
    if form.validate_on_submit():
        ...
        if valu == "":
            ...
            try:
                ...
                raise Exception("Forme non valide des parameters (dict).") from e
        ...
        return render_template('index.html', title='MCpMC', file=file,result=result, form=form, reward=estimated_reward, variance=estimated_variance, text=text)
        # result=result __above add in the list and also remove comments on previous command
    result = None
    text = None
